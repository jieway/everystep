...
|                    题目                    | 难度  |                         总结                         |
| :----------------------------------------: | :---: | :--------------------------------------------------: |
| [Leetcode-1480](alg/Leetcode-1480.md) |   1   |               在原数组上简单遍历即可。               |
| [Leetcode-1152](alg/Leetcode-1152.md) |   1   |              暴力写很简单，换一种思路！              |
| [Leetcode-1470](alg/Leetcode-1470.md) |   1   |                    简单题，练手。                    |
| [Leetcode-1431](alg/Leetcode-1431.md) |   1   |                    简单题，练手。                    |
...
|                   题目                   | 难度  |                               总结                               |
| :--------------------------------------: | :---: | :--------------------------------------------------------------: |
| [Leetcode-160](alg/Leetcode-160.md) |   1   |                  **双指针**，找两个链表的交点。                  |
| [Leetcode-141](alg/Leetcode-141.md) |   1   |                     **快慢指针**，注意细节！                     |
|  [Leetcode-21](alg/Leetcode-21.md)  |   2   |    合并两个有序链表，归并排序的思想，注意思考递归写法的实现！    |
|  [Leetcode-83](alg/Leetcode-83.md)  |   2   |                     **模拟题**，有序链表去重                     |
|  [Leetcode-82](alg/Leetcode-82.md)  |   3   |             **模拟题**，上一题的加强版，无序链表去重             |
|  [Leetcode-19](alg/Leetcode-19.md)  |   3   | **模拟题**，可以直接遍历，也可以用**快慢指针**写，注意特殊情况。 |
| [Leetcode-206](alg/Leetcode-206.md) |   2   |    **模拟题**，原地反装链表，迭代和递归，仔细思考递归实现 ！     |
| [Leetcode-234](alg/Leetcode-234.md) |   2   |           **模拟题**，容器的使用或者**反转链表比对**。           |
...
|                   题目                   | 难度  |                                        总结                                        |
| :--------------------------------------: | :---: | :--------------------------------------------------------------------------------: |
| [Leetcode-104](alg/Leetcode-104.md) |   1   |                **模拟题**，后面几道题都是在这道题的基础上增加东西。                |
| [Leetcode-110](alg/Leetcode-110.md) |   2   |                         **模拟题**，在遍历的时候设置条件。                         |
| [Leetcode-543](alg/Leetcode-543.md) |   3   |              **模拟题**，思维要灵活一点，设置一个全局变量来保存最值。              |
| [Leetcode-226](alg/Leetcode-226.md) |   3   |                **模拟题**，遍历的时候交换位置即可，同时可以练练 BFS                |
| [Leetcode-617](alg/Leetcode-617.md) |   3   | **模拟**，一共四种情况，其中某个节点非空两种情况，节点全空或者全不空，注意返回值。 |
| [Leetcode-112](alg/Leetcode-112.md) |   3   |               **模拟题**，类似于 112 题，注意递归返回值代表的意义。                |
| [Leetcode-437](alg/Leetcode-437.md) |   4   |                    **模拟题**，上一题的加强版，修改了部分条件。                    |
| [Leetcode-101](alg/Leetcode-101.md) |   5   |                           **模拟题**，这道题要好好思考。                           |
| [Leetcode-111](alg/Leetcode-111.md) |   3   |                    **模拟题**，比最长路径复杂，要考虑所有情况。                    |
| [Leetcode-404](alg/Leetcode-404.md) |   4   |                  依旧是在遍历上做文章，左叶子节点的特定就是条件。                  |
...
|                   题目                    | 难度  |                        总结                        |
| :---------------------------------------: | :---: | :------------------------------------------------: |
| [Leetcode-167](alg/Leetcode-167.md)  |   1   |         双指针思路起步，注意这个数组有序。         |
| [Leetcode-633](alg/Leetcode-633.md)  |   2   |          注意细节，考虑数据范围防止溢出。          |
| [Leetcode-283](alg/Leetcode-283.md)  |   3   |                      简答题。                      |  |
| [Leetcode-345](alg/Leetcode-345.md)  |   3   |                 回文有条件的筛选。                 |
| [Leetcode-680](alg/Leetcode-680.md)  |   4   |                   带条件的回文。                   |
|  [😝Leetcode-88](alg/Leetcode-88.md)  |   4   | 归并思想，要多练几遍！写第四遍的时候还存在盲区！！ |
| [😥Leetcode-141](alg/Leetcode-141.md) |   4   |       要注意细节鸭，第四次写的时候又卡住啦。       |
|   [🍿Leetcode-1](alg/Leetcode-1.md)   |   4   |    采用 map 来做的话注意要考虑键值之间的关系。     |
...
|                   题目                    | 难度  |                总结                |
| :---------------------------------------: | :---: | :--------------------------------: |
|  [Leetcode-69](alg/Leetcode-69.md)   |   2   |     注意整数相乘会导致数据溢出     |  |
| [😡Leetcode-540](alg/Leetcode-540.md) |   3   | 第三次写的时候依旧存在问题，注意！ |
