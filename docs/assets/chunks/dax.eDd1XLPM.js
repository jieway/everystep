const E=Object.freeze({displayName:"DAX",name:"dax",patterns:[{include:"#comments"},{include:"#keywords"},{include:"#labels"},{include:"#parameters"},{include:"#strings"},{include:"#numbers"}],repository:{comments:{patterns:[{begin:"//",captures:{0:{name:"punctuation.definition.comment.dax"}},end:`
...
`,name:"keyword.arithmetic.operator.dax"},{begin:"\\[",end:"\\]",name:"support.function.dax"},{begin:'"',end:'"',name:"string.quoted.double.dax"},{begin:"\\'",end:"\\'",name:"support.class.dax"}]},labels:{patterns:[{captures:{1:{name:"punctuation.separator.label.dax"},2:{name:"entity.name.label.dax"}},match:"(^(.*?)\\s*(:=|!=))"}]},metas:{patterns:[{begin:"\\(",beginCaptures:{0:{name:"meta.brace.round.dax"}},end:"\\)",endCaptures:{0:{name:"meta.brace.round.dax"}}}]},numbers:{match:`(?x)        # turn on extended mode
  ...
  )?        # make decimal portion optional`,name:"constant.numeric.dax"},parameters:{patterns:[{begin:"\\b(?<!\\.)(VAR)\\b(?<!\\.)\\b",beginCaptures:{1:{name:"keyword.control.dax"},2:{name:"variable.other.readwrite.dax"}},comment:"build out variable assignment",end:"=",endCaptures:{0:{name:"keyword.operator.assignment.dax"}},name:"meta.function.definition.parameters.dax",patterns:[{match:`(?x)
 = 
`,name:"keyword.control.dax"}]},{match:"[_$[:alpha:]][_$[:alnum:]]*",name:"variable.other.constant.dax"}]},strings:{begin:'"',end:'"',name:"string.quoted.double.dax",patterns:[{match:"\\\\.",name:"constant.character.escape.dax"}]}},scopeName:"source.dax"});var T=[E];export{T as default};
