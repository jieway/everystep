...
这个系列本质上是学习 MIT 6.828 JOS 2018 lab 过程中的副产物，即在研究 JOS 代码的过程中记下来的笔记，顺序调整了一下。个人认为 JOS 的学习过程比较陡峭，如果学习过程中代码写不出来很大程度上是概念理解不正确，参考测试进一步矫正，加深对概念的认识。收获还是挺大的，结合具体代码来学习 OS 可以消除很多困惑，单纯背概念很难搞清楚所有细节。

附录包含了如何配置环境，将代码跑起来，如果想要运行代码可以参考，一定程度上能够节省你的时间，避开一些坑。
